# Lesson 6.6 - VEH, Exceptions, Callbacks, Timers, and Threadpool Dispatch

---

> **Lesson Objective**
>
> Compare alternate dispatch mechanisms. By the end, you should be able to explain the concept, identify the evidence it creates, and describe the safety boundary that keeps the work in a controlled lab.
...
|---|---|---|
| Prior lessons in this module, Module 00 lab discipline, and a clean VM snapshot | dispatch surface map | A concrete lab artifact plus a defensible evidence note that separates observation, inference, validation, and cleanup |
...
```mermaid
flowchart LR
    A["Prerequisite model"] --> B["VEH, Exceptions, Callbacks, Timers, and Threadpool Dispatch"]
...
This lesson belongs to Arc 06B - Patchless and Alternative Dispatch Concepts. Its job is to make the learner reason about veh, exceptions, callbacks, timers, and threadpool dispatch as a set of mechanics, constraints, and observable side effects rather than as a technique name.
...
- explain the role of veh, exceptions, callbacks, timers, and threadpool dispatch in the module progression
...
2. What is one direct observation connected to veh, exceptions, callbacks, timers, and threadpool dispatch?
...
The next step is Threadless Execution and Context Manipulation Claims. Carry forward the same evidence habit: observe first, infer carefully, validate deliberately, and reset the lab when the exercise is complete.
