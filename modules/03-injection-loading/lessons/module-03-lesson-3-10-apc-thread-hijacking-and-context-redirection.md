# Lesson 3.10 - APC, Thread Hijacking, and Context Redirection

---

> **Lesson Objective**
>
> Explain context-dependent execution mechanisms. By the end, you should be able to explain the concept, identify the evidence it creates, and describe the safety boundary that keeps the work in a controlled lab.
...
|---|---|---|
| Prior lessons in this module, Module 00 lab discipline, and a clean VM snapshot | execution context comparison | A concrete lab artifact plus a defensible evidence note that separates observation, inference, validation, and cleanup |
...
```mermaid
flowchart LR
    A["Prerequisite model"] --> B["APC, Thread Hijacking, and Context Redirection"]
...
This lesson belongs to Arc 03C - Injection and Loading Families. Its job is to make the learner reason about apc, thread hijacking, and context redirection as a set of mechanics, constraints, and observable side effects rather than as a technique name.
...
- explain the role of apc, thread hijacking, and context redirection in the module progression
...
2. What is one direct observation connected to apc, thread hijacking, and context redirection?
...
The next step is Section-Based, Manual Mapping, Reflective Loading, and sRDI Concepts. Carry forward the same evidence habit: observe first, infer carefully, validate deliberately, and reset the lab when the exercise is complete.
