# Lesson 3.2 - Process and Thread Enumeration Fundamentals

---

> **Lesson Objective**
>
> Treat target discovery as data collection. By the end, you should be able to explain the concept, identify the evidence it creates, and describe the safety boundary that keeps the work in a controlled lab.
...
|---|---|---|
| Prior lessons in this module, Module 00 lab discipline, and a clean VM snapshot | process and thread inventory | A concrete lab artifact plus a defensible evidence note that separates observation, inference, validation, and cleanup |
...
```mermaid
flowchart LR
    A["Prerequisite model"] --> B["Process and Thread Enumeration Fundamentals"]
...
This lesson belongs to Arc 03A - Remote Process Readiness. Its job is to make the learner reason about process and thread enumeration fundamentals as a set of mechanics, constraints, and observable side effects rather than as a technique name.
...
- explain the role of process and thread enumeration fundamentals in the module progression
...
2. What is one direct observation connected to process and thread enumeration fundamentals?
...
The next step is Choosing a Stable Target and Requesting the Right Access. Carry forward the same evidence habit: observe first, infer carefully, validate deliberately, and reset the lab when the exercise is complete.
