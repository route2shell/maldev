# Lesson 3.12 - Hollowing, Startup Timing, and Image Replacement Families

---

> **Lesson Objective**
>
> Group suspended-process and image-replacement concepts. By the end, you should be able to explain the concept, identify the evidence it creates, and describe the safety boundary that keeps the work in a controlled lab.
...
|---|---|---|
| Prior lessons in this module, Module 00 lab discipline, and a clean VM snapshot | variant comparison | A concrete lab artifact plus a defensible evidence note that separates observation, inference, validation, and cleanup |
...
```mermaid
flowchart LR
    A["Prerequisite model"] --> B["Hollowing, Startup Timing, and Image Replacement Families"]
...
This lesson belongs to Arc 03D - Startup Manipulation and Strategy. Its job is to make the learner reason about hollowing, startup timing, and image replacement families as a set of mechanics, constraints, and observable side effects rather than as a technique name.
...
- explain the role of hollowing, startup timing, and image replacement families in the module progression
...
2. What is one direct observation connected to hollowing, startup timing, and image replacement families?
...
The next step is Masquerading, Lineage, Module Stomping, and Artifact Reduction. Carry forward the same evidence habit: observe first, infer carefully, validate deliberately, and reset the lab when the exercise is complete.
