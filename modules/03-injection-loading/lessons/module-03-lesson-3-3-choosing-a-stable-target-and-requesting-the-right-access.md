# Lesson 3.3 - Choosing a Stable Target and Requesting the Right Access

---

> **Lesson Objective**
>
> Teach target selection, architecture, session, integrity, and handle rights. By the end, you should be able to explain the concept, identify the evidence it creates, and describe the safety boundary that keeps the work in a controlled lab.
...
|---|---|---|
| Prior lessons in this module, Module 00 lab discipline, and a clean VM snapshot | target selection worksheet | A concrete lab artifact plus a defensible evidence note that separates observation, inference, validation, and cleanup |
...
```mermaid
flowchart LR
    A["Prerequisite model"] --> B["Choosing a Stable Target and Requesting the Right Access"]
...
This lesson belongs to Arc 03A - Remote Process Readiness. Its job is to make the learner reason about choosing a stable target and requesting the right access as a set of mechanics, constraints, and observable side effects rather than as a technique name.
...
- explain the role of choosing a stable target and requesting the right access in the module progression
...
2. What is one direct observation connected to choosing a stable target and requesting the right access?
...
The next step is Reading Remote State Before Changing Anything. Carry forward the same evidence habit: observe first, infer carefully, validate deliberately, and reset the lab when the exercise is complete.
