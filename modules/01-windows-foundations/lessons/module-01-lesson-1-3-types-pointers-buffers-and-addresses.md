# Lesson 1.3 - Types, Pointers, Buffers, and Addresses

---

> **Lesson Objective**
>
> Build raw-memory literacy without drowning in C minutiae. By the end, you should be able to explain the concept, identify the evidence it creates, and describe the safety boundary that keeps the work in a controlled lab.
...
|---|---|---|
| Prior lessons in this module, Module 00 lab discipline, and a clean VM snapshot | pointer and address inspection | A concrete lab artifact plus a defensible evidence note that separates observation, inference, validation, and cleanup |
...
```mermaid
flowchart LR
    A["Prerequisite model"] --> B["Types, Pointers, Buffers, and Addresses"]
...
This lesson belongs to Arc 01A - Native C and Memory Literacy. Its job is to make the learner reason about types, pointers, buffers, and addresses as a set of mechanics, constraints, and observable side effects rather than as a technique name.
...
- explain the role of types, pointers, buffers, and addresses in the module progression
...
2. What is one direct observation connected to types, pointers, buffers, and addresses?
...
The next step is Strings, Unicode, Structs, and Data Layout. Carry forward the same evidence habit: observe first, infer carefully, validate deliberately, and reset the lab when the exercise is complete.
