# Lesson 1.2 - Toolchain, Project Layout, and Your First Windows Program

---

> **Lesson Objective**
>
> Build a reliable edit-build-run-inspect loop and compile a minimal WinAPI program. By the end, you should be able to explain the concept, identify the evidence it creates, and describe the safety boundary that keeps the work in a controlled lab.
...
|---|---|---|
| Prior lessons in this module, Module 00 lab discipline, and a clean VM snapshot | compile and inspect a simple program | A concrete lab artifact plus a defensible evidence note that separates observation, inference, validation, and cleanup |
...
```mermaid
flowchart LR
    A["Prerequisite model"] --> B["Toolchain, Project Layout, and Your First Windows Program"]
...
This lesson belongs to Arc 01A - Native C and Memory Literacy. Its job is to make the learner reason about toolchain, project layout, and your first windows program as a set of mechanics, constraints, and observable side effects rather than as a technique name.
...
- explain the role of toolchain, project layout, and your first windows program in the module progression
...
2. What is one direct observation connected to toolchain, project layout, and your first windows program?
...
The next step is Types, Pointers, Buffers, and Addresses. Carry forward the same evidence habit: observe first, infer carefully, validate deliberately, and reset the lab when the exercise is complete.
