# Lesson 1.9 - Handles, Access Masks, Modules, PEB, and TEB

---

> **Lesson Objective**
>
> Explain object access gates and process self-knowledge. By the end, you should be able to explain the concept, identify the evidence it creates, and describe the safety boundary that keeps the work in a controlled lab.
...
|---|---|---|
| Prior lessons in this module, Module 00 lab discipline, and a clean VM snapshot | module, handle, and context notes | A concrete lab artifact plus a defensible evidence note that separates observation, inference, validation, and cleanup |
...
```mermaid
flowchart LR
    A["Prerequisite model"] --> B["Handles, Access Masks, Modules, PEB, and TEB"]
...
This lesson belongs to Arc 01B - Windows Process and Memory Model. Its job is to make the learner reason about handles, access masks, modules, peb, and teb as a set of mechanics, constraints, and observable side effects rather than as a technique name.
...
- explain the role of handles, access masks, modules, peb, and teb in the module progression
...
2. What is one direct observation connected to handles, access masks, modules, peb, and teb?
...
The next step is From Source to PE: Compiler, Linker, CRT, and Entry Points. Carry forward the same evidence habit: observe first, infer carefully, validate deliberately, and reset the lab when the exercise is complete.
