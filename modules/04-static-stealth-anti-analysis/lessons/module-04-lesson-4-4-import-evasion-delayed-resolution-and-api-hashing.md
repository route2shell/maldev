# Lesson 4.4 - Import Evasion, Delayed Resolution, and API Hashing

---

> **Lesson Objective**
>
> Explain import minimization and hashed lookup patterns without mysticism. By the end, you should be able to explain the concept, identify the evidence it creates, and describe the safety boundary that keeps the work in a controlled lab.
...
|---|---|---|
| Prior lessons in this module, Module 00 lab discipline, and a clean VM snapshot | import visibility comparison | A concrete lab artifact plus a defensible evidence note that separates observation, inference, validation, and cleanup |
...
```mermaid
flowchart LR
    A["Prerequisite model"] --> B["Import Evasion, Delayed Resolution, and API Hashing"]
...
This lesson belongs to Arc 04B - Representation and Resolution Changes. Its job is to make the learner reason about import evasion, delayed resolution, and api hashing as a set of mechanics, constraints, and observable side effects rather than as a technique name.
...
- explain the role of import evasion, delayed resolution, and api hashing in the module progression
...
2. What is one direct observation connected to import evasion, delayed resolution, and api hashing?
...
The next step is Custom Import Resolution and API Set Awareness. Carry forward the same evidence habit: observe first, infer carefully, validate deliberately, and reset the lab when the exercise is complete.
