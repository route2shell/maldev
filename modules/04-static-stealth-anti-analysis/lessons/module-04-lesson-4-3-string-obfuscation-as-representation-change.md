# Lesson 4.3 - String Obfuscation as Representation Change

---

> **Lesson Objective**
>
> Teach string hiding as transformation with runtime recovery. By the end, you should be able to explain the concept, identify the evidence it creates, and describe the safety boundary that keeps the work in a controlled lab.
...
|---|---|---|
| Prior lessons in this module, Module 00 lab discipline, and a clean VM snapshot | before/after string inspection | A concrete lab artifact plus a defensible evidence note that separates observation, inference, validation, and cleanup |
...
```mermaid
flowchart LR
    A["Prerequisite model"] --> B["String Obfuscation as Representation Change"]
...
This lesson belongs to Arc 04B - Representation and Resolution Changes. Its job is to make the learner reason about string obfuscation as representation change as a set of mechanics, constraints, and observable side effects rather than as a technique name.
...
- explain the role of string obfuscation as representation change in the module progression
...
2. What is one direct observation connected to string obfuscation as representation change?
...
The next step is Import Evasion, Delayed Resolution, and API Hashing. Carry forward the same evidence habit: observe first, infer carefully, validate deliberately, and reset the lab when the exercise is complete.
