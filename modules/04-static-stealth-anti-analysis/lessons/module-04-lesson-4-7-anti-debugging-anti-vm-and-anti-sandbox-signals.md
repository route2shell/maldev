# Lesson 4.7 - Anti-Debugging, Anti-VM, and Anti-Sandbox Signals

---

> **Lesson Objective**
>
> Teach environment checks as assumptions with false-positive risk. By the end, you should be able to explain the concept, identify the evidence it creates, and describe the safety boundary that keeps the work in a controlled lab.
...
|---|---|---|
| Prior lessons in this module, Module 00 lab discipline, and a clean VM snapshot | environment-signal worksheet | A concrete lab artifact plus a defensible evidence note that separates observation, inference, validation, and cleanup |
...
```mermaid
flowchart LR
    A["Prerequisite model"] --> B["Anti-Debugging, Anti-VM, and Anti-Sandbox Signals"]
...
This lesson belongs to Arc 04C - Anti-Analysis and Analyst Reconstruction. Its job is to make the learner reason about anti-debugging, anti-vm, and anti-sandbox signals as a set of mechanics, constraints, and observable side effects rather than as a technique name.
...
- explain the role of anti-debugging, anti-vm, and anti-sandbox signals in the module progression
...
2. What is one direct observation connected to anti-debugging, anti-vm, and anti-sandbox signals?
...
The next step is Static Stealth Failure Modes. Carry forward the same evidence habit: observe first, infer carefully, validate deliberately, and reset the lab when the exercise is complete.
