# Lesson 10.7 - Milestone 4: Static and Runtime Visibility Review

---

> **Lesson Objective**
>
> Apply prior modules as controlled observations. By the end, you should be able to explain the concept, identify the evidence it creates, and describe the safety boundary that keeps the work in a controlled lab.
...
|---|---|---|
| Prior lessons in this module, Module 00 lab discipline, and a clean VM snapshot | visibility evidence | A concrete lab artifact plus a defensible evidence note that separates observation, inference, validation, and cleanup |
...
```mermaid
flowchart LR
    A["Prerequisite model"] --> B["Milestone 4: Static and Runtime Visibility Review"]
...
This lesson belongs to Arc 10B - Controlled Build Milestones. Its job is to make the learner reason about milestone 4: static and runtime visibility review as a set of mechanics, constraints, and observable side effects rather than as a technique name.
...
- explain the role of milestone 4: static and runtime visibility review in the module progression
...
2. What is one direct observation connected to milestone 4: static and runtime visibility review?
...
The next step is Telemetry and Analyst Review of the Capstone. Carry forward the same evidence habit: observe first, infer carefully, validate deliberately, and reset the lab when the exercise is complete.
