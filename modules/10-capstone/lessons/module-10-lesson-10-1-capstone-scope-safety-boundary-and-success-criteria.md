# Lesson 10.1 - Capstone Scope, Safety Boundary, and Success Criteria

---

> **Lesson Objective**
>
> Define what the capstone is and is not. By the end, you should be able to explain the concept, identify the evidence it creates, and describe the safety boundary that keeps the work in a controlled lab.
...
|---|---|---|
| Prior lessons in this module, Module 00 lab discipline, and a clean VM snapshot | capstone charter | A concrete lab artifact plus a defensible evidence note that separates observation, inference, validation, and cleanup |
...
```mermaid
flowchart LR
    A["Prerequisite model"] --> B["Capstone Scope, Safety Boundary, and Success Criteria"]
...
This lesson belongs to Arc 10A - Capstone Design. Its job is to make the learner reason about capstone scope, safety boundary, and success criteria as a set of mechanics, constraints, and observable side effects rather than as a technique name.
...
- explain the role of capstone scope, safety boundary, and success criteria in the module progression
...
2. What is one direct observation connected to capstone scope, safety boundary, and success criteria?
...
The next step is Final Implant Architecture Blueprint. Carry forward the same evidence habit: observe first, infer carefully, validate deliberately, and reset the lab when the exercise is complete.
