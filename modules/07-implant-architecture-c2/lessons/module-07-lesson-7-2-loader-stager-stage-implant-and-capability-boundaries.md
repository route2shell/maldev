# Lesson 7.2 - Loader, Stager, Stage, Implant, and Capability Boundaries

---

> **Lesson Objective**
>
> Separate roles that learners often conflate. By the end, you should be able to explain the concept, identify the evidence it creates, and describe the safety boundary that keeps the work in a controlled lab.
...
|---|---|---|
| Prior lessons in this module, Module 00 lab discipline, and a clean VM snapshot | role taxonomy | A concrete lab artifact plus a defensible evidence note that separates observation, inference, validation, and cleanup |
...
```mermaid
flowchart LR
    A["Prerequisite model"] --> B["Loader, Stager, Stage, Implant, and Capability Boundaries"]
...
This lesson belongs to Arc 07A - Implant Architecture. Its job is to make the learner reason about loader, stager, stage, implant, and capability boundaries as a set of mechanics, constraints, and observable side effects rather than as a technique name.
...
- explain the role of loader, stager, stage, implant, and capability boundaries in the module progression
...
2. What is one direct observation connected to loader, stager, stage, implant, and capability boundaries?
...
The next step is Reference Implant Architecture Blueprint. Carry forward the same evidence habit: observe first, infer carefully, validate deliberately, and reset the lab when the exercise is complete.
