# Lesson 7.8 - Communication Profiles and Traffic Shape

---

> **Lesson Objective**
>
> Teach headers, cadence, and behavior profiles conceptually. By the end, you should be able to explain the concept, identify the evidence it creates, and describe the safety boundary that keeps the work in a controlled lab.
...
|---|---|---|
| Prior lessons in this module, Module 00 lab discipline, and a clean VM snapshot | profile comparison | A concrete lab artifact plus a defensible evidence note that separates observation, inference, validation, and cleanup |
...
```mermaid
flowchart LR
    A["Prerequisite model"] --> B["Communication Profiles and Traffic Shape"]
...
This lesson belongs to Arc 07C - Profiles, Timing, and OPSEC. Its job is to make the learner reason about communication profiles and traffic shape as a set of mechanics, constraints, and observable side effects rather than as a technique name.
...
- explain the role of communication profiles and traffic shape in the module progression
...
2. What is one direct observation connected to communication profiles and traffic shape?
...
The next step is Transport Families and Tradeoffs. Carry forward the same evidence habit: observe first, infer carefully, validate deliberately, and reset the lab when the exercise is complete.
