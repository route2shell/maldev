# Lesson 5.8 - Network, Beacon, and Timing Signals

---

> **Lesson Objective**
>
> Preview communication visibility before C2 architecture. By the end, you should be able to explain the concept, identify the evidence it creates, and describe the safety boundary that keeps the work in a controlled lab.
...
|---|---|---|
| Prior lessons in this module, Module 00 lab discipline, and a clean VM snapshot | timing profile worksheet | A concrete lab artifact plus a defensible evidence note that separates observation, inference, validation, and cleanup |
...
```mermaid
flowchart LR
    A["Prerequisite model"] --> B["Network, Beacon, and Timing Signals"]
...
This lesson belongs to Arc 05B - Major Telemetry Surfaces. Its job is to make the learner reason about network, beacon, and timing signals as a set of mechanics, constraints, and observable side effects rather than as a technique name.
...
- explain the role of network, beacon, and timing signals in the module progression
...
2. What is one direct observation connected to network, beacon, and timing signals?
...
The next step is Technique-to-Telemetry Mapping. Carry forward the same evidence habit: observe first, infer carefully, validate deliberately, and reset the lab when the exercise is complete.
