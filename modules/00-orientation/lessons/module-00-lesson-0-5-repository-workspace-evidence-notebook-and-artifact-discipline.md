# Lesson 0.5 - Repository Workspace, Evidence Notebook, and Artifact Discipline

---

> **Lesson Objective**
>
> Create the repeatable course workspace, evidence folders, source-code folders, screenshot paths, and observation notes used in every module. By the end, you should be able to explain the concept, identify the evidence it creates, and describe the safety boundary that keeps the work in a controlled lab.
...
|---|---|---|
| Prior lessons in this module, Module 00 lab discipline, and a clean VM snapshot | repository workspace and evidence notebook template | A concrete lab artifact plus a defensible evidence note that separates observation, inference, validation, and cleanup |
...
```mermaid
flowchart LR
    A["Prerequisite model"] --> B["Repository Workspace, Evidence Notebook, and Artifact Discipline"]
...
This lesson belongs to Arc 00B - Lab and Learning Workflow. Its job is to make the learner reason about repository workspace, evidence notebook, and artifact discipline as a set of mechanics, constraints, and observable side effects rather than as a technique name.
...
- explain the role of repository workspace, evidence notebook, and artifact discipline in the module progression
...
2. What is one direct observation connected to repository workspace, evidence notebook, and artifact discipline?
...
The next step is First Build-Run-Inspect Smoke Test. Carry forward the same evidence habit: observe first, infer carefully, validate deliberately, and reset the lab when the exercise is complete.
