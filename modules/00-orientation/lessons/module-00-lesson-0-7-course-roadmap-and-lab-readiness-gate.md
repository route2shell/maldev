# Lesson 0.7 - Course Roadmap and Lab Readiness Gate

---

> **Lesson Objective**
>
> Show why the course is ordered the way it is and confirm the lab is ready for hands-on work. By the end, you should be able to explain the concept, identify the evidence it creates, and describe the safety boundary that keeps the work in a controlled lab.
...
|---|---|---|
| Prior lessons in this module, Module 00 lab discipline, and a clean VM snapshot | annotated dependency map and readiness sign-off | A concrete lab artifact plus a defensible evidence note that separates observation, inference, validation, and cleanup |
...
```mermaid
flowchart LR
    A["Prerequisite model"] --> B["Course Roadmap and Lab Readiness Gate"]
...
This lesson belongs to Arc 00C - Roadmap and Readiness. Its job is to make the learner reason about course roadmap and lab readiness gate as a set of mechanics, constraints, and observable side effects rather than as a technique name.
...
- explain the role of course roadmap and lab readiness gate in the module progression
...
2. What is one direct observation connected to course roadmap and lab readiness gate?
