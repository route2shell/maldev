# Lesson 0.4 - Developer Environment and Tooling Workflow

---

> **Lesson Objective**
>
> Install and verify compilers, editors, debuggers, PE tools, process tools, and telemetry utilities. By the end, you should be able to explain the concept, identify the evidence it creates, and describe the safety boundary that keeps the work in a controlled lab.
...
|---|---|---|
| Prior lessons in this module, Module 00 lab discipline, and a clean VM snapshot | tool installation checklist and version notes | A concrete lab artifact plus a defensible evidence note that separates observation, inference, validation, and cleanup |
...
```mermaid
flowchart LR
    A["Prerequisite model"] --> B["Developer Environment and Tooling Workflow"]
...
This lesson belongs to Arc 00B - Lab and Learning Workflow. Its job is to make the learner reason about developer environment and tooling workflow as a set of mechanics, constraints, and observable side effects rather than as a technique name.
...
- explain the role of developer environment and tooling workflow in the module progression
...
2. What is one direct observation connected to developer environment and tooling workflow?
...
The next step is Repository Workspace, Evidence Notebook, and Artifact Discipline. Carry forward the same evidence habit: observe first, infer carefully, validate deliberately, and reset the lab when the exercise is complete.
